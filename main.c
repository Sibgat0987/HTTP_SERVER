...
#endif
/*winsock2.h: Provides networking functions like creating and managing sockets.
*/
#include <winsock2.h>
#include <windows.h>
#include <ws2tcpip.h>
#include <iphlpapi.h>
/*iphlpapi.h: Provides functions to manage IP addresses and network interfaces.
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
/*This line tells the linker to include the Winsock 2 library (Ws2_32.lib) during the
 linking phase of compilation. Winsock functions require this library to work.*/
#pragma comment(lib, "Ws2_32.lib") 

#define BUFLEN 1024 // space allocated to buffer that we will be receiving from server
...
int main()
{
    ...
    int res, sendRes;
    int running;
    WSADATA wsaData; /*info about windows socket is stored here*/
    ...
    // set as listener
    //SOMAXCONN sets the maximum number of pending connections that can be queued.
 ...
 /* This function will close the socket and clean up Winsock when the server is shutting down.*/
void cleanup(SOCKET listener)
{
